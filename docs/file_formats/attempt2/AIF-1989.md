# RISC OS Application Image Format

> **Technical Memorandum**

| Field          | Value                                                                 |
|----------------|-----------------------------------------------------------------------|
| **Subject**    | RISC OS Application Image Format (previously Arthur Image Format)     |
| **Reference**  | PLG-AIF                                                               |
| **Issue**      | 1.00                                                                  |
| **Authors**    | Lee Smith (2nd September 1987), Lionel Haines (26th October 1988), Lee Smith (23rd January 1989) |
...
| 14-Aug-87   | Limited circulation for comment (RWilson, RCownie, MJordan, NRaine, PFellows, JThackray, HMeekings, SWoodward); support for Dbug continues to worry LDS... |
...
| 17-Jan-89   | Major revision: improved support for relocatable images, improved support for ASD/Dbug, editorial review |
...
### Uncompressed / Decompressed AIF Image
...
- Only AIF images can **self-move** to a location which leaves a requested amount of workspace.
...
2. In contrast, the rules for constructing RISC OS Relocatable Modules
   (RM) require that it be prepared to shut itself down, be moved in memory,
