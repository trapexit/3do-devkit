...
The format of the time stamp is described in [Time Stamps](#time-stamps). Its value is an encoded version of the last-modified time of the file from which the library member was created.
...
![Time Stamps](Figures/TimeStamps.gif)
