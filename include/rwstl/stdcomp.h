...
/* #define RWSTD_BOUNDS_CHECKING 1 */
/* #define _RWSTD_RENAME_EXCEPTION 1 */
/* #define RWSTD_RENAME_EXCEPTION 1 */
...
#define RWSTD_MSC22_STATIC_INIT_BUG 1 /* not really a static init bug -- really a lack of common data problem */
...
#ifdef READY_FOR_RWSTD_ALLOCATOR_SAD
...
#define __cheap_assert(e) ((e) ? (void)0 : __assert(#e, "throw", 0))
#define RWSTD_THROW_NO_MSG(PRED,EXC)  __cheap_assert(!(PRED))
#define RWSTD_THROW(PRED,EXC,MESG) __cheap_assert(!(PRED))
#endif
//
