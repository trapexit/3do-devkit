...
$Id: controlport.h,v 1.3 1994/01/21 02:53:20 limes Exp $
...
#define CONTROLPORTCMD_WAIT		3	/* Wait for CP data frame */
#define CONTROLPORTCMD_READWRITE	4       /* bicoastal strangeness */
