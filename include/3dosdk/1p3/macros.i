; $Id: macros.i,v 1.4 1994/02/09 02:04:35 limes Exp $

; *************************************************************************
;
; Macro Definition Include File
;
; Copyright (C) 1992, New Technologies Group, Inc.
; NTG Trade Secrets  -  Confidential and Proprietary
;
; The contents of this file were designed with tab stops of 8 in mind
;
; DATE   NAME             DESCRIPTION
; ------ ---------------- -------------------------------------------------
; 930326 SHL              Added LIBCALL and SETSWI macros
