; $Id: structs.i,v 1.6 1994/02/09 02:04:35 limes Exp $
 IF :DEF:|__structs_i|
 ELSE
	GBLL	|__structs_i|
...
; *************************************************************************
;
; Opera Structure Definition Macros Include File
;
...
; ------ ---------------- -------------------------------------------------
; 921029 Dale Luck        added int8 and uint8 and Item
; 921017 -RJ              Added INT32 and UINT32
; 920724 -RJ Mical        Start overhaul
; 920709 Stephen Landrum  Last edits before July handoff
;
; ********************************************************************** */


; Assembly language include file with macros for structure object declaration
