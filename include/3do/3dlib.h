...
typedef struct point3f16 point3f16;
struct point3f16
{
  frac16 x;
  frac16 y;
...
typedef struct SoundDefinition SoundDefinition;
...
struct WorldObject
{
  ...
  WorldObject *wo_ParentObject; /* for hier. objects. NULL if this is not hierarchacal */
...
typedef	struct WorldPort WorldPort;
struct WorldPort
{
...
typedef struct SpecialVertex SpecialVertex;
...
typedef struct Lib3DState Lib3DState;
struct Lib3DState
{
