...
/* In order to provide the necessary precision, DEFAULT_YSCANTIME is increased
 * by a 	 */
/* multiple of 10.  This is taken into considertation when calculating x and y
 * positions */
...
extern int32 LG_ConnectEventBroker (MsgPort **msgPortPtr, Item *msgPortItemPtr,
...
extern int32 LG_CalibrateGun (ScreenContext *screen, MsgPort *msgPort,
                              Item msgPortItem, Item msgItem, int32 x,
                              int32 y);
