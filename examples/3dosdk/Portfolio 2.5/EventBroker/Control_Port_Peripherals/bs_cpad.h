...
#define BS_InitCPadData(a)                                                    \
  memset (a, 0, sizeof (BS_CPadData));                                        \
  BS_SetCPadMinX (a, -1);                                                     \
  BS_SetCPadMaxX (a, BS_XRES);                                                \
  BS_SetCPadMinY (a, -1);                                                     \
  BS_SetCPadMaxY (a, BS_YRES);                                                \
  BS_SetCPadDX (a, 1);                                                        \
  BS_SetCPadDY (a, 1);                                                        \
  BS_SetCPadWrapF (a, 0)
...
extern int BS_ProcessCPadData (BS_CPadData *, uint32 deBounceBits,
                               int axisEmulF);
