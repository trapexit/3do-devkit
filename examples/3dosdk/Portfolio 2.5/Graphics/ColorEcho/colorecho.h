...
#define PPMP_BOTH_NORMAL                                                      \
  ((PPMP_MODE_NORMAL << PPMP_0_SHIFT) | (PPMP_MODE_NORMAL << PPMP_1_SHIFT))
#define PPMP_BOTH_AVERAGE                                                     \
  ((PPMP_MODE_AVERAGE << PPMP_0_SHIFT) | (PPMP_MODE_AVERAGE << PPMP_1_SHIFT))
#define PPMP_BOTH_MIXED                                                       \
...
int32 RandomPixels (Item BitMap, int32 XCenter, int32 YCenter,
                    int32 NumPixels);
