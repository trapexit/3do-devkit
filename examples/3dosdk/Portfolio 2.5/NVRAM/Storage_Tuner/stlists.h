...
#define kScaleCellCCBs                                                        \
  0x00040000 /* scale the cell's CCBs to the cell's bounds */
...
typedef struct ListCell
{
  ...
  CCB *
      lcn_HiliteCCB; /* a ccb for use when cell is hilited (or NULL if none) */
...
typedef struct ListHandler
{
  ...
  MoveCursorProc lh_MoveCursorProc; /* optional proc to move the cursor to the
                                       next cell */
