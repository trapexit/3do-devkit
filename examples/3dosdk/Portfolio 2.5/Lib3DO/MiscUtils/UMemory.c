 ...
 *					allocation flag	now provides 99% of the
 *functionality this module used to implement.  This module provides the
 *remaining (nearly trivial) 1%.
 *
 ...
 *
 *	- Existing code references these functions using the address-of
 *operator, and &Malloc and &Free just don't work when Malloc/Free are macros.
 ****************************************************************************/

#include "umemory.h"

void *
Malloc (uint32 size, uint32 memtype)
{
  if (size == 0)
    {
      return NULL;
