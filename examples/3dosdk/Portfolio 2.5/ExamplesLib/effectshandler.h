...
#define MAKEEHERR(class, errNum)                                              \
  MakeErr (ER_USER, ER_EH, ER_SEVERE, ER_E_USER, class, errNum)
...
extern Err ehNewMixerInfo (pTMixerInfo *pNewMixerInfo, int32 channelsUsed,
...
extern Err ehSetupSamplePlayer (pTSampleInfo pSampleInfo,
                                const char *sampleName);
extern Err ehConnectSamplePlayer (pTMixerInfo pMixerInfo,
                                  pTSampleInfo pSampleInfo, int32 channel);
extern Err ehDisconnectSamplePlayer (pTMixerInfo pMixerInfo,
                                     pTSampleInfo pSampleInfo);
extern Err ehLoadSoundEffect (pTSampleInfo *pNewSampleInfo,
                              pTMixerInfo pMixerInfo, const char *sampleName,
                              int32 channel);

extern void ehSetChannelLevels (pTMixerInfo pMixerInfo, Item leftKnob,
                                Item rightKnob, int32 volume, int32 balance);
