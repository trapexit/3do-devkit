...
#define MAKECPADERR(class, errNum)                                            \
  MakeErr (ER_USER, ER_CPAD, ER_SEVERE, ER_E_USER, class, errNum)
...
extern int32 DoControlPad (int32 whichPad, uint32 *pButton,
                           int32 continuousBits);
