...
#	File:		StrTest.make
#
#	Contains:	Test CString class (makefile)
#
#	Written by:	pab
#
...
OBJECTS			=	"{ObjectDir}CString.cp.o" 			¶
...
#####################################
{ObjectDir}{Application}.cp.o		Ä	"{3DOLibs}"Lib3DO.lib {Application}.make CString.h
{ObjectDir}CString.cp.o				Ä	"{3DOLibs}"Lib3DO.lib {Application}.make CString.h
