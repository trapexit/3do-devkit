...
Usage( char* programName )
{
	...
	kprintf ("\t				the stream in between switching streams.\n");
}
...
int main (int argc, char **argv)
	...
	if ( argc < 3 )
	{
		kprintf("### %s - invalid parameter list, need at least a stream file name.\n", argv[0], argv[parmNdx]);
		Usage(argv[0]);
		exit(0);
	}
	...
	if ( argc % 2 == 0 )
	{
		kprintf("### %s - invalid parameter list, need a stream type specified for each stream file name.\n", argv[0], argv[parmNdx]);
		Usage(argv[0]);
		exit(0);
	}
