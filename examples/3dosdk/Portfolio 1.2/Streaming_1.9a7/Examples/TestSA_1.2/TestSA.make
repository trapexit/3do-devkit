...
#####################################
COptions		=    -zps0 -za1 -i "{3DOIncludes}" -i "{StreamDir}" -i "{SubscriberDir}" -i "{AudioSubsDir}" -d DEBUG={DebugFlag}
#COptions		= -g -zps0 -za1 -i "{3DOIncludes}" -i "{StreamDir}" -i "{SubscriberDir}" -i "{AudioSubsDir}" -d DEBUG={DebugFlag}
...
#####################################
{Program}.c.o		Ä	{Program}.c  "{Program}.h"
