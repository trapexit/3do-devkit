/**************************************************************************************
 **	Project:		AIFF_2to1 - Read AIFF and AIFC files, compress 2:1 with squareroot-delta-exact
 ...
 **	 3/10/93	RDG		altered CompressSSND prototype to pass CommChunk
 ...
 *********************************************************************/
long CompressSSND(iff_control_ptr in_ptr,iff_control_ptr out_ptr, ExtCommonChunk theCommChunk);	
