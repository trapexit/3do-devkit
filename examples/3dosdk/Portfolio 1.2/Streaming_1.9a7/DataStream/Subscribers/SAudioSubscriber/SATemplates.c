...
/* Turn on to enable trace buffer event tracking for this file */
#define TRACE_TEMPLATES	0
 ...
 *******************************************************************************************/
Item	GetTemplateItem( TemplateRecPtr	tp, long templateTag, long templateCount )
	{
	long	k;
 ...
 *******************************************************************************************/
long	LoadTemplates( TemplateRecPtr tp, long* tagPtr, long templateCount )
	{
	long	status;
	...
	ADD_TRACE( kLoadedTemplates, -1, 0, 0 );
