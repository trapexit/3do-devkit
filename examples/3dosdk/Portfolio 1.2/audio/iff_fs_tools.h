...
#ifndef _iff_fs_tools_h
#define _iff_fs_tools_h
...
extern "C"
{
  ...
  int32 iffReadChunkData (iff_control *iffc, void *data, uint32 numbytes);
...
#if 0
int32 iffOpenFileWrite (iff_control *iffc, char *filename);
