/*
   ...
   3DO Company.
        ...
        Change History (most recent first):
                 ...
                 <2>	 7/28/93	JAY		creating extern for
   SPORTDevice that use to be in graphics.h before Dragon Tail release.  Will
   most likely be removed for final release
...
OpenSPORT (void)
{
  ...
  for (i = 1; i >= 0; i--)
    if ((SPORTIO[i] = CreateItem (MKNODEID (KERNELNODE, IOREQNODE), targs))
        < 0)
      {
