...
/* if it doesn't work, so what? */
  ...
  prev = NULL;
	...
	spr = LoadSprite("vspics/testd50.cel", Convert32_F16(1),Convert32_F16(2), 0x00002000, Convert32_F16(2)); 
	spr = LoadSprite("vspics/testo50.cel", Convert32_F16(2),Convert32_F16(2), 0x00002800, Convert32_F16(3));  
  spr = LoadSprite("vspics/test3.cel", Convert32_F16(1), Convert32_F16(1), 0x00001000, Convert32_F16(1)); 
