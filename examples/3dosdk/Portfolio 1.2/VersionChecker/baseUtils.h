...
/*
	...
	Change History (most recent first):
		 ...
		 <4>	 6/30/93	CDE		Added USE_STRCASECMP, changed #ifdef
		 <3>	 6/29/93	CDE		Added define strncasecmp for 4B1
		 <2>	 6/29/93	CDE		General fixup per Robert
		 							Removed DBUG, FULLDBUG macros
...
#define	STATUS(x) { if (gShowStatus) kprintf("## %s\n",x);}
