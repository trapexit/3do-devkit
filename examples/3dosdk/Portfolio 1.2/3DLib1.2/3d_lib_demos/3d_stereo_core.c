/**************************************************************************
 * 3d_stereo_core : tests the 3d-lib stereo-glasses support               *
 **************************************************************************
 *                                                                        *
 ...
 * and an object orbiting the cube in stereo mode.                        *
 *                                                                        *
 * Exit the program using the "pause" button on the control unit. Use the *
