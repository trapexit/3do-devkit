...
#	File:		menu.make
#
#	Contains:	make file for building menu.
#
...
#		 <4>	 6/23/93	JAY		add stack check option (-zps0) to COptions. Needed for Dragon
#									Release (4B1)
#		 <3>	  4/7/93	JAY		make the make consistant
#		 <2>	  4/3/93	JAY		add LIBS to the Link dependencies
