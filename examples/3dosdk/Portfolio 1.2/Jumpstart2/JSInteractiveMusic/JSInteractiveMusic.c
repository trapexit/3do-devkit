/*
	...
	Contains:	Variation of JSInteractiveSound which plays background music
	...
	Change History (most recent first):
		 ...
		 <1>	 1/4/94		CDE		Derived from old Jumpstart's GameUFO.c;
		 							Replaced direct joypad access with event broker interface;
									Constrained behavior to that of JSInteractiveSound with music-playing by
...
bool InitGame(void)
{
	...
	if ((iSoundHandler = LoadProgram("$boot/JSData/Sound/JSPlayBgndMusic.task")) < 0)
		{
