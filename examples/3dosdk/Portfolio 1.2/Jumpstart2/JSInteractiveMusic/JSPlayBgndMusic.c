/*
	...
	Files used:
		...
		$boot/JSData/Sound/BackgroundMusic.aiff		-	Background music sound file played by this task
	...
	Change History (most recent first):
		 ...
		 <1>	 1/5/94		CDE		Derived from PlayBgndMusic.c from old Jumpstart's GameUFO example
*/
...
int main(int argc, char* argv[])
{
	...
	while (1)
	{
		...
		while (psfpBackgroundMusic->sfp_LastPos < psfpBackgroundMusic->sfp_NumToRead)
		{
