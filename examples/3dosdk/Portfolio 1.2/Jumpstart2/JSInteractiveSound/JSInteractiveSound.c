/*
        ...
        Files used:
                ...
                $boot/JSData/Art/sky.img		-	background
   image $boot/JSData/Art/JSUFO.cel		-	the UFO cel
                $boot/JSData/Art/Cockpit.cel	-	the cockpit cel
                $boot/JSData/Art/Crosshairs.cel	-	the crosshairs "cursor"
   cel $boot/JSData/Art/Laser.cel		-	the laser beam cel
                $boot/JSData/Art/Options.cel	-	the options buttons ccb
                $boot/JSData/Sound/zap.aiff		-	the zap sound
   effect
...
Zap (CCB *pcTarget, Coord X, Coord Y)
{
  ...
  if (X >= 0 && Y >= 0 && (Y < (pcTarget->ccb_Height / (iDistance >> 8)))
