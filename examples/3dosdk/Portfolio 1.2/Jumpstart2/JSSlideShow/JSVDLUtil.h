/*
	...
	Contains:	Routines to mess around with video display lists (header).
	...
	Change History (most recent first):
		 ...
		 <1>	 1/7/94		CDE		Derived from ourVDL.h
*/
...
void 	MergeVDL(VDLEntry *rawVDLPtr, VDLEntry *activeVDLPtr);
