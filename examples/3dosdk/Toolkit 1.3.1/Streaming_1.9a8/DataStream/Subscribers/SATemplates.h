 ...
 *	File:			SATemplates.h
 *
 *	Contains:		Definitions for instrument template tags used by the subscriber
 *					to preload instrument templates before playback.
 *
 *	Written by:		Darren Gibbs, adapted from the prototype subscriber by Joe Buczek.
 *
 *	Copyright © 1993 The 3DO Company. All Rights Reserved.
 *
 *	History:
 *	1/20/94		rdg		make C++ compatible
 *	10/20/93	jb		Change conditionals to use __CC_NORCROFT for 3DO builds
