 ...
 *	File:			SAChannel.h
 *
 *	Contains:		Definitions the logical channel data structures.
 *
 ...
 *						Get rid of envelope rate knobs... set once and for all at init time.
...
long  	InitChannel( struct SAudioContext* ctx, struct SAudioHeaderChunk* headerPtr );
...
long	SetChannelAmplitude( struct SAudioContext* ctx, long channelNumber, long newAmp );
long	SetChannelPan( struct SAudioContext* ctx, long channelNumber, long newPan );
long	GetChannelAmplitude( struct SAudioContext* ctx, long channelNumber, long* Amp );
long	GetChannelPan( struct SAudioContext* ctx, long channelNumber, long* Pan );
long	MuteChannel( struct SAudioContext* ctx, long channelNumber, Boolean callerFlag );
long	UnMuteChannel( struct SAudioContext* ctx, long channelNumber, Boolean callerFlag );

void	BeginPlaybackIfAppropriate( struct SAudioContext* ctx, long channelNumber );
