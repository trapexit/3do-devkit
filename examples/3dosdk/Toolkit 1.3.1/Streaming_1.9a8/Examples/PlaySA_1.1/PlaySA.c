 ...
 *channel number (0 - 4). "C" button:		Rewinds the stream
 ...
 *
 *	History:
 *	10/31/93		rdg		v1.1  Modify to use logical channel
 *3 10/26/93		rdg		Modify to use more complete joypad
 *implementation Add button combinations for muting channels
