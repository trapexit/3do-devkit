...
#	define NewPtr(size, memType) 	\
		Leaks_Malloc(size, memType, __LINE__, __FILE__)
#	define Malloc(size, memType) 	\
		Leaks_Malloc(size, memType, __LINE__, __FILE__)
...
#	define MemBlockSize(ptr)	InternalMemBlockSize(ptr, int32 lineNum, char *fileName)
#	define GetPtrSize(ptr)		InternalMemBlockSize(ptr, int32 lineNum, char *fileName)
