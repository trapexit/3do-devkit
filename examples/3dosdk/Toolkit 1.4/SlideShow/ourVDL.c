/*
	...
	Change History (most recent first):
		 ...
		 <5>	 1/18/94	JAY		change MergeVDL function definition to match the prototype in
									ourVDL.h due to stricker type checking by 1.6v2 armcc
...
#define		ODD(num)	(num & 1)
	...
	//  GrafBase->gf_VDLPostDisplay).  Leave it set to zero and let SubmitVDL
	// fix it up.
 	vdlRecPtr = (VDL_REC *)&vdlArrayPtr[kScreenHeight - 1];
	vdlRecPtr->nextVDLEntry	= 0;
