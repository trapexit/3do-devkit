/*
   ...
   3DO Company.
        ...
        Change History (most recent first):
                 ...
                 <3>	  9/6/93	JAY		change 2nd argument in
   the LoadInstrument to 0 for DragonTail6. Removed conditional compiles and
   search directories for finding dsp files <2>	  8/5/93	JAY
   putting in place the final system directory scheme for the Dragon Tail
   release. Affects how dsp, aiff files are referenced. Getting rid of the
   multiple trials of pathnames (almost). Replacing with alias $audio which
   should work forever in any environment
