/*
   ...
   3DO Company.
        ...
        Change History (most recent first):
                 <9> 	 3/15/94	MPH		Changed to handle PAL
   sized Images.  Stripped all VDL calls because PAL currently cannot support
   it. Plus, the VDL implementation will be changing. Hence, do not try it for
   now.
