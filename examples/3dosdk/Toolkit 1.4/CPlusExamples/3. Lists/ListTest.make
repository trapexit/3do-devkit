...
#	File:		ListTest.make
#
#	Contains:	Test list management classes (makefile)
#
#	Written by:	pab
#
...
#####################################
{ObjectDir}{Application}.cp.o		Ä	"{3DOLibs}"Lib3DO.lib {Application}.make CList.h
{ObjectDir}CList.cp.o				Ä	"{3DOLibs}"Lib3DO.lib {Application}.make CList.h
