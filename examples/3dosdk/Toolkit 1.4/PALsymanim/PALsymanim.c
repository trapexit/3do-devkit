/*
   ...
   3DO Company.
        ...
        Change History (most recent first):
                 <9>	 5/13/94	MPH		Modified PALsymanim to
   use the new QueryGraphics() call instead of looking at GrafBase for
   determining PAL or NTSC mode. Replaced references to GrafBase->VRAMPageSize
   with GetPageSize(MEMTYPE_VRAM).
