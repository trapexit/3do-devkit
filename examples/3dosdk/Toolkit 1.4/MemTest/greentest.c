/*
        ...
        Contains:	Program to perform memory tests and other diagnostics
   on the GREEN Sherrie hardware
   ...
   3DO Company.
        ...
        Change History (most recent first):
                                 ...
                                 5/09/94	crm		removed
   explicit references to GrafBase struct <1>	 8/20/93	JAY
   first checked in
...
#define DBUGXY(s, x, y)                                                       \
  {                                                                           \
    sprintf s; /* if (MACEXISTS) printf ("%s", sbuf); */                      \
    gGrafCon.gc_PenX = x;                                                     \
    gGrafCon.gc_PenY = y;                                                     \
  ...
  if (oldcount != errorcount[0])
    {
      ...
      DBUGXY ((sbuf, "%8lx %8lx %8lx %8lx\n", errorcount[4 + 0],
               errorcount[4 + 1], errorcount[4 + 2], errorcount[4 + 3]),
              22, erry + 10);
      DBUGXY ((sbuf, "%8lx %8lx %8lx %8lx\n", errorcount[8 + 0],
               errorcount[8 + 1], errorcount[8 + 2], errorcount[8 + 3]),
              22, erry + 20);
  ...
  for (; numpasses > 0; numpasses--)
    {
      ...
      if (!Paused)
        {
          memtest (r, (void *)((uint32)mem1 + i * 4),
                   (void *)((uint32)mem1 + size1 - 32), 0xffffffff);
          memerror ();
          memtest (r, (void *)((uint32)mem2 + i * 4),
                   (void *)((uint32)mem2 + size2 - 32), 0xffffffff);
          memerror ();
          memtest (0, (void *)((uint32)mem1 + i * 4),
                   (void *)((uint32)mem1 + size1 - 32), 0xffffffff);
          memerror ();
          memtest (0, (void *)((uint32)mem2 + i * 4),
                   (void *)((uint32)mem2 + size2 - 32), 0xffffffff);
          memerror ();
          memtest2 (r, (void *)((uint32)mem1 + i * 4),
                    (void *)((uint32)mem1 + size1 - 32), 0xffffffff);
          memerror ();
          memtest2 (r, (void *)((uint32)mem2 + i * 4),
                    (void *)((uint32)mem2 + size2 - 32), 0xffffffff);
          memerror ();
          memtest2 (0, (void *)((uint32)mem1 + i * 4),
                    (void *)((uint32)mem1 + size1 - 32), 0xffffffff);
          memerror ();
          memtest2 (0, (void *)((uint32)mem2 + i * 4),
                    (void *)((uint32)mem2 + size2 - 32), 0xffffffff);
          memerror ();
          if (++i == 8)
            i = 0;
