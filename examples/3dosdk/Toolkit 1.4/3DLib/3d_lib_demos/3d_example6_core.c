/**************************************************************************
 * 3d_example6_core : Demonstrates hierarchacal objects.                  *
 **************************************************************************
 *                                                                        *
 ...
 *                                                                        *
 **************************************************************************
 * This will create a single world with cube and a pyramid. The pyramid   *
 * is balanced onto one side of the cube and inherits it's rotation and   *
 * translation while rotating on its own.                                 *
 **************************************************************************/
...
int32 View_X=0, View_Y=0,View_Z= (-5<<16) , Camera_angle=0;
int32 Delta_x=0, Delta_y=0, Delta_z=0, Delta_camera_angle;
...
main_loop(void)
{
   ...
   for(;;)
   {
      /*** if the user has pressed the START button, exit ***/
	   ...
	   if(!DrawImage(Screencontext.sc_Screens[screen_select],BackPic,&Screencontext))
       {
...
process_joystick(void)
{
   int32 rvalue;
   int32 joybits;
   static int32 delta_y=0, delta_x=0, delta_z=0, delta_camera_angle=0;
