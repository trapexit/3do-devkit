 ...
 *	File:			SlideStream.c
 *
 *	Contains:		Example of using JoinSubscriber.c to implement a slide show with audio.
 *
...
int	 main( int argc, char **argv )
	...
	status = PlayImageStream( &gScreenContext, argv[1], (PlayerUserFn) myUserFunction, NULL );
