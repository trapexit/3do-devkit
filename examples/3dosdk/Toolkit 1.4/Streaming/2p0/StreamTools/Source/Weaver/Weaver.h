 ...
 *	10/20/93	jb		Add ASCII TAB to the whitespace list of characters
 *	7/11/93		jb		Add MARKEROUT_FLAG_STRING
 *	6/27/93		jb		Add IOBUFSIZE_FLAG_STRING
 *	6/17/93		jb		Make names of command line flag strings more mnemonic.
 *	5/15/93		jb		New today. Copied 'StreamChunk' struct from DataStream.h
 *						and added the 'streamChunkTime' common time stamp field.
 *
 *******************************************************************************************/
...
#define	IsWhiteSpace(c)			((c == ' ') || (c == '\t') || (c == 0x0A) || (c == 0x0D))
