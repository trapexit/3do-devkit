 ...
 *readibility and compilation using ObjectMaster). 9/28/93		jb
 *Version 1.1d1 Add dumping for APOS and AMAP chunks; add command line switches
 *to control dumping of all chunks. 9/16/93		jb
