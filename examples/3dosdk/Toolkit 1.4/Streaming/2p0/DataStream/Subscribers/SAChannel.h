 ...
 *						Make "channel" function names
 *unique 1/20/94		rdg		make C++ compatible 10/26/93
 *rdg		Version 2.9 Get rid of envelope rate knobs... set once and for
 *all at init time. Distinguish between user and internal muting and unmuting
