 ...
 *in a channel structure to allow reuse of this code for other subscriber
 *queues. Now use a generic SubsQueuePtr instead of a channel ptr as input.
 *	5/5/93		njc		New today, copied here from separate
 *subscriber code.
 *
 *******************************************************************************************/
 ...
 *******************************************************************************************/
Boolean
AddDataMsgToTail (SubsQueuePtr queue, SubscriberMsgPtr subMsg)
{
 ...
 *messages for the given channel.
 *******************************************************************************************/
SubscriberMsgPtr
GetNextDataMsg (SubsQueuePtr queue)
{
