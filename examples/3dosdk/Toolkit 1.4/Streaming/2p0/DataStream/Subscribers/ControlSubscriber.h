 ...
 *readibility and compilation using ObjectMaster). 11/23/93	jb
 *Added prototype for CloseCtrlSubscriber()
 *	8/16/93		jb		Change CTRL_NUM_DS_REQS_MSGITEMS to
 *CTRL_NUM_DS_REQS_MSGS because we need to allocate msg buffer space as well as
 *message items. Change dsReqMsgItemPool to dsReqMsgPool.
