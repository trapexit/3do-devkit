 ...
 *readibility and compilation using ObjectMaster). 11/29/93	jb
 *Integrated changes from Neil Cormia's version of the code. 11/23/93	jb
 *Added prototype for CloseJoinSubscriber() 11/18/93	njc		Renamed
 *_FlushJoin to FlushJoinSubscriber and made it global in scope. 6/16/93
 *jb		Added JOIN_CHUNK_TYPE, JOIN_HEADER_SUBTYPE, JOIN_DATA_SUBTYPE
