 ...
 *adjust stream 'offset' from current position. 12/2/93		jb
 *Version 1.7 Added argument to NewDataStream() to specify the number of
 *						subscriber messages that should be
 *allocated upon stream creation. Removed the definition of
...
/* indicates a chunk that does not
