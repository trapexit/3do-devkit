 ...
 *bashing by the ARM C compiler. 5/18/93		jb		Switch
 *'unassignedList' to 'inUseList'. Add tracking of "owned" items by keeping an
 *"in-use" list and verifying the existence of items being returned to the
 *pool. 3/29/93		jb		New today.
 *
 *******************************************************************************************/
