...
#####################################
COptions		= -g -zps0 -za1 -i "{3DOIncludes}" -i "{StreamDir}" -i "{SubscriberDir}" -d DEBUG={DebugFlag} {RelativeBranchSwitch}
...
{ObjectDir}DataAcq.c.o			Ä	DataAcq.h DataStream.h  MsgUtils.h ¶
