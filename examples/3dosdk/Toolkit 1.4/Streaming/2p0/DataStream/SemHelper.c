 ...
 *	File:			SemHelper.c
 *
 *	Contains:		wrapper routines for kernel semaphore related services
 *
...
/*******************************************************************************************
 * Routine to create a uniquely named semaphore given a name preamble string, and some
 * unique 32-bit value. Typically, the uniqueID value is an address of something that
 * is guaranteed to not be ureused until the semaphore is deleted.
 *******************************************************************************************/
