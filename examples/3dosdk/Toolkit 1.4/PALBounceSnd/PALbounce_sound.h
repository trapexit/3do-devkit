/*
   ...
   3DO Company.
        ...
        Change History (most recent first):
                 <3> 	3/10/93		MPH		Changed for PAL
   version.
                 <2>	  4/5/93	JAY		removing /remote/ from
   filename (i.e. making pathname relative to initial working directory <1>
   4/3/93	JAY		first checked in
...
/* Shorter... */
#define BALL_TV_SND "PALBounceFolder/sound/Bird.aiff"
#define BALL_GLOBE_SND "PALBounceFolder/sound/3DO.aiff"
#define TV_CUBE_SND "PALBounceFolder/sound/Interactive.aiff"
#define CUBE_GLOBE_SND "PALBounceFolder/sound/MultiPlayer.aiff"
#define BALL_FLOOR_SND "PALBounceFolder/sound/BallBnce.aiff"
#define TV_FLOOR_SND "PALBounceFolder/sound/TvBnce.aiff"
#define CUBE_FLOOR_SND "PALBounceFolder/sound/CubeBnce.aiff"
#define GLOBE_FLOOR_SND "PALBounceFolder/sound/GlobeBnce.aiff"
