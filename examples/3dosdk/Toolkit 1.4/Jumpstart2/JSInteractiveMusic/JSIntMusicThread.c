/*
        ...
        Contains:	Variation of JSInteractiveMusic which uses a thread
                                instead of a child task to play the background
   music
   ...
   3DO Company.
        ...
        Change History (most recent first):
                 ...
                 <1>	 1/4/94		CDE		Derived from
   JSInteractiveMusic.c and JSPlayBgndMusic.c; Inserted code for
   JSPlayBgndMusic and changed task management to thread management
*/
