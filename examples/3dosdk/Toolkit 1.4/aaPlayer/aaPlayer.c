/*
   ...
   3DO Company.
        ...
        Change History (most recent first):
                                 ...
                                 5/09/94	crm		removed
   explicit references to GrafBase struct <2+>	 8/10/93	JAY
   change calling sequence to LoadAnim for new Lib3DO.lib <2>	 7/31/93
   JAY		add IO parameters to SetVRAMPages() and CopyVRAMPages() for
                                                                        Dragon
   Tail release <1>	 6/25/93	JAY		first checked in 6/1/93
   ec		Updated for dragon. 4/1/93		ec		New
   today
