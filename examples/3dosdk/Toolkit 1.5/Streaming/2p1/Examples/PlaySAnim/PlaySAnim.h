 ...
 *Streams created from Director 4.0.
 *
 *******************************************************************************************/
...
#define NUM_DIRECTOR_CHANNELS 48
...
static int32 InitSAnimPlayerFromStreamHeader (SAnimPlayerPtr ctx,
                                              char *streamFileName);
...
static DSDataBufPtr CreateBufferList (long numBuffers, long bufferSize,
                                      SAnimPlayerPtr ctx);
static int32 SetupSAnimSubscriber (SAnimPlayerPtr ctx,
                                   DSHeaderSubsPtr subsPtr);
static int32 SetupAudioSubscriber (SAnimPlayerPtr ctx,
                                   DSHeaderSubsPtr subsPtr);
static int32 SetupControlSubscriber (SAnimPlayerPtr ctx,
                                     DSHeaderSubsPtr subsPtr);
