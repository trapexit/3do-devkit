...
void	PrintfSAError( int32 DSStatus )
	{
#if DEBUG
	char*	err;
	...
	switch ( DSStatus )
	{
	case kPSVersionErr:			err = "kPSVersionErr - Streamed Anim version mismatch"; break;
	case kPSMemFullErr:		err = "kPSMemFullErr - memory full in Streamed Anim "; break;
	case kPSUnknownSubscriber:		err = "kPSUnknownSubscriber - unkown subscriber type"; break;
	case kPSHeaderNotFound:		err = "kPSHeaderNotFound - No Stream Header Found. Add 'writestreamheader' to weave script"; break;
