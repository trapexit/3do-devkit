...
{ObjectDir}{Program}.c.o	Ä	{MakeFileName}
 
#####################################
#	Include file dependencies (DonÕt change this line or put anything after this section.)
#####################################

"{ObjectDir}"ProtoPlayer.c.o	Ä	:JoyPad.h
"{ObjectDir}"ProtoPlayer.c.o	Ä	:::DataStream:DataStreamDebug.h
"{ObjectDir}"ProtoPlayer.c.o	Ä	:::DataStream:DataStream.h
"{ObjectDir}"ProtoPlayer.c.o	Ä	:::DataStream:MsgUtils.h
"{ObjectDir}"ProtoPlayer.c.o	Ä	:::DataStream:MemPool.h
"{ObjectDir}"ProtoPlayer.c.o	Ä	:::DataStream:SubsChunkCommon.h
"{ObjectDir}"ProtoPlayer.c.o	Ä	:::DataStream:HaltChunk.h
"{ObjectDir}"ProtoPlayer.c.o	Ä	:::DataStream:DSStreamHeader.h
"{ObjectDir}"ProtoPlayer.c.o	Ä	:::DataStream:DataStreamLib.h
"{ObjectDir}"ProtoPlayer.c.o	Ä	:::DataStream:DataStream.h
"{ObjectDir}"ProtoPlayer.c.o	Ä	:::DataStream:DataAcq.h
"{ObjectDir}"ProtoPlayer.c.o	Ä	:::DataStream:ItemPool.h
"{ObjectDir}"ProtoPlayer.c.o	Ä	:::DataStream:MarkerChunk.h
"{ObjectDir}"ProtoPlayer.c.o	Ä	:::DataStream:Subscribers:Includes:SubscriberUtils.h
"{ObjectDir}"ProtoPlayer.c.o	Ä	:::DataStream:DataStreamLib.h
"{ObjectDir}"ProtoPlayer.c.o	Ä	:::DataStream:SubsChunkCommon.h
"{ObjectDir}"ProtoPlayer.c.o	Ä	:::DataStream:Subscribers:Includes:ProtoSubscriber.h
"{ObjectDir}"ProtoPlayer.c.o	Ä	:::DataStream:DataStream.h
"{ObjectDir}"ProtoPlayer.c.o	Ä	:::DataStream:Subscribers:Includes:SubscriberUtils.h
"{ObjectDir}"ProtoPlayer.c.o	Ä	:::DataStream:Subscribers:Includes:ProtoErrors.h
"{ObjectDir}"ProtoPlayer.c.o	Ä	:::DataStream:Subscribers:Includes:ProtoTraceCodes.h
"{ObjectDir}"ProtoPlayer.c.o	Ä	:::DataStream:Subscribers:Includes:ProtoChannels.h
"{ObjectDir}"ProtoPlayer.c.o	Ä	:::DataStream:MemPool.h
"{ObjectDir}"ProtoPlayer.c.o	Ä	:::DataStream:Subscribers:Includes:SubscriberUtils.h
"{ObjectDir}"ProtoPlayer.c.o	Ä	:::DataStream:HaltChunk.h
"{ObjectDir}"ProtoPlayer.c.o	Ä	:::DataStream:Subscribers:Includes:ControlSubscriber.h
"{ObjectDir}"ProtoPlayer.c.o	Ä	:::DataStream:Subscribers:Includes:SubscriberUtils.h
"{ObjectDir}"ProtoPlayer.c.o	Ä	:::DataStream:ItemPool.h
