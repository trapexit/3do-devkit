...
#	make Depends -f NuPlayer.make  ·· Dev:Null > temp.makeout; temp.makeout ·· Dev:Null; delete -i temp.makeout
#
##########################################################################
...
"{ObjectDir}"NuPlayer.c.o	Ä	:JoyPad.h
"{ObjectDir}"NuPlayer.c.o	Ä	:PlayCPakStream.h
"{ObjectDir}"NuPlayer.c.o	Ä	:PrepareStream.h
"{ObjectDir}"NuPlayer.c.o	Ä	:::DataStream:DataStreamLib.h
"{ObjectDir}"NuPlayer.c.o	Ä	:::DataStream:DataStream.h
"{ObjectDir}"NuPlayer.c.o	Ä	:::DataStream:MsgUtils.h
"{ObjectDir}"NuPlayer.c.o	Ä	:::DataStream:MemPool.h
"{ObjectDir}"NuPlayer.c.o	Ä	:::DataStream:SubsChunkCommon.h
"{ObjectDir}"NuPlayer.c.o	Ä	:::DataStream:HaltChunk.h
"{ObjectDir}"NuPlayer.c.o	Ä	:::DataStream:DSStreamHeader.h
"{ObjectDir}"NuPlayer.c.o	Ä	:::DataStream:DataAcq.h
"{ObjectDir}"NuPlayer.c.o	Ä	:::DataStream:ItemPool.h
"{ObjectDir}"NuPlayer.c.o	Ä	:::DataStream:MarkerChunk.h
"{ObjectDir}"NuPlayer.c.o	Ä	:::DataStream:Subscribers:Includes:SubscriberUtils.h
"{ObjectDir}"NuPlayer.c.o	Ä	:::DataStream:DataStreamLib.h
"{ObjectDir}"NuPlayer.c.o	Ä	:::DataStream:SubsChunkCommon.h
"{ObjectDir}"NuPlayer.c.o	Ä	:::DataStream:Subscribers:Includes:SAudioSubscriber.h
"{ObjectDir}"NuPlayer.c.o	Ä	:::DataStream:DataStream.h
"{ObjectDir}"NuPlayer.c.o	Ä	:::DataStream:Subscribers:Includes:SubscriberUtils.h
"{ObjectDir}"NuPlayer.c.o	Ä	:::DataStream:Subscribers:Includes:SAStreamChunks.h
"{ObjectDir}"NuPlayer.c.o	Ä	:::DataStream:Subscribers:Includes:SubscriberUtils.h
"{ObjectDir}"NuPlayer.c.o	Ä	:::DataStream:Subscribers:Includes:SAChannel.h
"{ObjectDir}"NuPlayer.c.o	Ä	:::DataStream:MemPool.h
"{ObjectDir}"NuPlayer.c.o	Ä	:::DataStream:Subscribers:Includes:SubscriberUtils.h
"{ObjectDir}"NuPlayer.c.o	Ä	:::DataStream:Subscribers:Includes:SATemplates.h
"{ObjectDir}"NuPlayer.c.o	Ä	:::DataStream:Subscribers:Includes:SAStreamChunks.h
"{ObjectDir}"NuPlayer.c.o	Ä	:::DataStream:Subscribers:Includes:SAControlMsgs.h
"{ObjectDir}"NuPlayer.c.o	Ä	:::DataStream:Subscribers:Includes:CPakSubscriber.h
"{ObjectDir}"NuPlayer.c.o	Ä	:::DataStream:Subscribers:Includes:SubscriberUtils.h
"{ObjectDir}"NuPlayer.c.o	Ä	:::DataStream:Subscribers:Includes:codec.h
"{ObjectDir}"NuPlayer.c.o	Ä	:::DataStream:DataStreamLib.h
"{ObjectDir}"NuPlayer.c.o	Ä	:::DataStream:Subscribers:Includes:ControlSubscriber.h
"{ObjectDir}"NuPlayer.c.o	Ä	:::DataStream:Subscribers:Includes:SubscriberUtils.h
"{ObjectDir}"NuPlayer.c.o	Ä	:::DataStream:ItemPool.h
"{ObjectDir}"NuPlayer.c.o	Ä	:::DataStream:DataStreamDebug.h
...
"{ObjectDir}"PlayCPakStream.c.o	Ä	:::DataStream:DataAcq.h
"{ObjectDir}"PlayCPakStream.c.o	Ä	:::DataStream:Subscribers:Includes:SAudioSubscriber.h
"{ObjectDir}"PlayCPakStream.c.o	Ä	:::DataStream:Subscribers:Includes:CPakSubscriber.h
"{ObjectDir}"PlayCPakStream.c.o	Ä	:::DataStream:Subscribers:Includes:SubscriberUtils.h
