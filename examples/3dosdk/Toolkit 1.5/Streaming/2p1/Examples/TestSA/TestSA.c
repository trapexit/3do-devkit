 ...
 *						Fix Bug #3336: Fixed usage documentation
 *on "B" button. Added include <stdio.h> 12/2/93		jb
 *Add addition new arg to NewDataStream() 10/11/93	rdg		Make
 *sure CLOSE_AUDIO_ON_SWITCH re-enables channels after they are closed. 9/30/93
 *rdg		Change CLOSE_AUDIO_ON_SWITCH to send close messages to channels
 *0-4 on rewind. 9/29/93		rdg		Enable chans 1-4, don't
 *init volume to zero.
 *	9/28/93		rdg		Fix volume control... was impossible to
...
Usage (char *programName)
{
  ...
  printf (
      "\t\"B\" button:	Toggles current channel number between 0 - 4.\n");
