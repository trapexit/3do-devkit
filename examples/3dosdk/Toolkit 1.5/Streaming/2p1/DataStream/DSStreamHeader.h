 ...
 *
 *	History:
 *  6/23/94			rdg	    fixed bug in SubsChunkHeader definition... no trailing semicolon
 *  5/19/94			fyp	    Version 2.0  integrated lla and nmd's changes for condition RELATIVE_BRANCHING
 ...
 *	12/2/93			jb		Added 'numSubsMsgs' to stream header; changed stream
 *							version to 2.
