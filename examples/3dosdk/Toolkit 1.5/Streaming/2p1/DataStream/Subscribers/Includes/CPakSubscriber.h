 ...
 *						Deleted #ifndef __DATASTREAM_H__,
 *conditional include of "DataStreamLib.h". Integrated ccw's changes: added x &
 *y position to channel data structure. 4/27/94		fyp
