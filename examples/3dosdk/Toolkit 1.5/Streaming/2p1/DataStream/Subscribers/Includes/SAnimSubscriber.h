 ...
 *
 *	History:
 *	7/16/94		dld		Changed SANM_MAX_CHANNELS to 48 for Streams created from Director 4.0.
 ...
 *	11/23/93	jb		Add CloseSAnimSubscriber() routine prototype
 *	9/15/93		jb		Add 'APOS' and 'AMAP' structures.
