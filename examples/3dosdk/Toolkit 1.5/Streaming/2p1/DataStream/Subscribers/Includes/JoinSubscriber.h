 ...
 *						Integrated header support for ccw's changes.
 ...
 *	11/29/93	jb		Integrated changes from Neil Cormia's version of the code.
 *	11/23/93	jb		Added prototype for CloseJoinSubscriber()
