...
enum SAudioErrorCode {
	...
	SAudioErrUnsupSoundfileType,			/* Format of audio data not playable by subscriber */
	SAudioErrConnectInstFailed,				/* Could not connect some DSP instrument to another */
	SAudioErrGrabKnobFailed,				/* Could not grab a knob on some DSP instrument */
	SAudioErrCouldntAllocBufferPool,		/* Could not allocate a pool of buffer structures */
	...
	SAudioErrCouldntCreateContextPool,		/* Create the memory pool for SASubscriber contexts */
	SAudioErrStreamVersionInvalid			/* Subscriber not able to play this version of SAudio data */
	};
