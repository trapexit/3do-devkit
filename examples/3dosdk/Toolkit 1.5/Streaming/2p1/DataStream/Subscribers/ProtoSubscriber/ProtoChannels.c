 ...
 *
 *	Contains:		Routines for logical channel specific functions.
 *
 ...
 *	7/07/94		rdg		Use unique #define names for trace switching
 ...
 *******************************************************************************************/
long	InitProtoChannel( ProtoContextPtr ctx, ProtoHeaderChunkPtr headerPtr )
	{
	long				status;
	...
	ADD_PROTO_TRACE_L2( ProtoTraceBufPtr, kTraceChannelInit, headerPtr->channel, 0, 0 );
	...
	if ( !IsProtoChanInitalized(chanPtr) )
		{
		/* Make sure this version of Proto files are compatible with this subscriber */
 ...
 *******************************************************************************************/
long		StartProtoChannel( ProtoContextPtr ctx, long channelNumber )
	{
	long			status;
	ProtoChannelPtr	chanPtr;
	...
	ADD_PROTO_TRACE_L2( ProtoTraceBufPtr, kTraceChannelStart, channelNumber, 0, 0 );
 ...
 *******************************************************************************************/
long		StopProtoChannel( ProtoContextPtr ctx, long channelNumber )
	{
	long				status;
	ProtoChannelPtr		chanPtr;
	...
	ADD_PROTO_TRACE_L2( ProtoTraceBufPtr, kTraceChannelStop, channelNumber, 0, 0 );
 ...
 *******************************************************************************************/
long		FlushProtoChannel( ProtoContextPtr ctx, long channelNumber )
	{
	long				status;
	ProtoChannelPtr		chanPtr;
	...
	ADD_PROTO_TRACE_L2( ProtoTraceBufPtr, kTraceChannelFlush, channelNumber, 0, 0 );
	...
	if ( IsProtoChanEnabled(chanPtr) )	
		...
		while (	( msgPtr = GetNextDataMsg( &chanPtr->dataMsgQueue ) ) != NULL ) 	
			...
			ADD_PROTO_TRACE_L2( ProtoTraceBufPtr, kFlushedDataMsg, channelNumber, 0 , msgPtr );
 ...
 *******************************************************************************************/
long		CloseProtoChannel( ProtoContextPtr ctx, long channelNumber )
	{
	long				status;
	ProtoChannelPtr		chanPtr;
	...
	ADD_PROTO_TRACE_L2( ProtoTraceBufPtr, kTraceChannelClose, channelNumber, 0, 0 );
 ...
 *******************************************************************************************/
long	ProcessNewProtoDataChunk( ProtoContextPtr ctx, SubscriberMsgPtr subMsg )
{
	long				status;
	...
	ADD_PROTO_TRACE_L3( ProtoTraceBufPtr, kTraceChannelNewDataArrived, channelNumber, 0, subMsg );
