 ...
 *
 *	History:
 *	07/07/94		rdg		renamed the members of HaltChunk
 *struct for more readablity.
 *	07/06/94		dtc		Added a newline at end of file,
 *otherwise the compiler chokes. 06/30/94		jb		New
 *today.
 *
 *******************************************************************************************/
...
#define STREAM_CHUNK_TYPE                                                     \
  CHAR4LITERAL ('S', 'T', 'R', 'M') /* chunk type for Streamer Control */
#define HALT_CHUNK_TYPE                                                       \
  CHAR4LITERAL ('H', 'A', 'L', 'T') /* sub-type for streamer HALT function */
...
{
  SimpleChunk streamerPart;   /* The Streamer parses this chunk header... */
  SimpleChunk subscriberPart; /* And delivers this part to the subscriber */
} HaltChunk;
