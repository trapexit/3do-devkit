...
Bug #2660: Check if QuickTime is installed. Bug #3297: Perform error checking
...
user to specify the output filename: -o <outputfilename> Fixed a problem that
      ...
      do
        {
          ...
          FilmF.time
              = CvtTo3DOTime (sampleTime, (Fixed)(mediaTimeScale << 16));
      ...
      if (*argv[parms] != '-')
               ...
               && (strlen (argv[parms]) == 2))
        {
          ...
          gMarkerRate = strtol (argv[parms], &pEnd, 10);
               ...
               && (strlen (argv[parms]) == 2))
        {
          // bump to the next param & grab the marker time, as long as we have
          // a next param
          //  of course
          ++parms;
          if (parms == argc)
