 ...
 *	History:
 *
 *	 8/30/94	dld		Changed the line that dumps sccb_Y to say
 *						"sccb_Y" instead of "sccb_X".
 *	7/24/94		dtc		Version 1.2
 *						Changed version number to 1.2
 *	7/17/94		dld		Changed dump of x,y positions to floating point.  These values
 *						are 16.16, and so I am dumping them as decimal floating point
 *						values converted on-the-fly.
 *	5/12/94		dtc		Version 1.1d2
 ...
 *	9/28/93		jb		Version 1.1d1
 *						Add dumping for APOS and AMAP chunks; add command line switches to
 *						control dumping of all chunks.
 *	9/16/93		jb		Version 1.0d2
 *						Add capability to dump old fashioned cel files (non-stream).
 *						Decode the AV Value in the PIXC word.
 *	9/14/93		jb		Version 1.0d1
 *						Started with source code of DumpStream.c tool. Does extensive
 *						decoding of the CCB flags, PIXC, and Preamble control words.
 *	=======================================================================================
