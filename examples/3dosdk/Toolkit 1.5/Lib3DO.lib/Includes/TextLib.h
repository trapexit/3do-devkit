 ...
 *
 *	  05/08/94	Ian		Added TagArg interface.  Added DetachTextCelCCB().
 *
 *	  03/05/94	Ian		Added tc_tabStops field to TextCel structure.
 *						Added SetTextCelTabStops() and GetTextCelTabStops().
 *
 *	  02/14/94	Edgar	Created format flags for text justification,
 *						TC_FORMAT_LEFT_JUSTIFY, TC_FORMAT_RIGHT_JUSTIFY,
 *						and TC_FORMAT_CENTER_JUSTIFY.  Created a mask
 *						to go with the just. flags, TC_FORMAT_JUSTIFY_MASK.
 *
 *	  02/11/94	Edgar	Added prototypes for SetTextCelFormatFlags() and
 *						GetTextCelFormatFlags().  Changed the comments
 *						for the TC_FORMAT_WORDWRAP flag.
 * 
