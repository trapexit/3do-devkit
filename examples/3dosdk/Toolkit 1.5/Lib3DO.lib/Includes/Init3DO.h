 ...
 *	File:		Init3DO.h
 *
 *	Contains:	This file contains routines to initialize all the major components 
 ...
 *	01/28/93  dsm	Creating a single global pointer to a ScreenContext Structure
 ...
 *	12/27/92  dsm	Adding constants for bit flags to be returned by StartUp so we
 *					can separately check for success of opening Graphics, Audio,
 *					SportIO, and MacLink.
 *	12/10/92  JML	gBitmaps and gBitmapItems are now external variables.
 *	12/10/92  JML	nFrameByteCount is now an external variable.
