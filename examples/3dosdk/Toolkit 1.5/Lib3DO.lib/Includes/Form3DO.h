 ...
 *	04/02/93  JAY 	replace old definition of RGB555 with something more useful
 *					in our ARMCC environment
 *	01/28/93  dsm 	Fixed #define for CHUNK_CRDT
 *	01/28/93  dsm 	first checked in
 * 
