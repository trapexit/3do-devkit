/*
        ...
        Contains:	Routine to display current task and kernal memory usage
   via debugging printf(), and routines to support that display.
   ...
   3DO Company.
        ...
        Change History (most recent first):
                 ...
                 <9>	 7/27/93	ian		Split into separate
   module for inclusion in Lib3DO. <8+>	 5/17/93	akm		Adding
   rudimentary memory leak support <8>	 5/13/93	akm		Changed
   abort() to Debug();
                 <7>	 5/13/93	akm		Added eric*s changes
   from JPIDemo integration
                 <6>	 5/13/93	akm		Fixed header problems
   for old mem check routines
                 <5>	 5/13/93	akm		Split shared memory
   routines into seperate file. Added Phil*s AvailMem code. <4>	 5/11/93
   akm		Changed sharedmemory structures to work around compiler bug <3>
   5/7/93	akm		Added new implementations for shared memory
   routines
                 <2>	  5/3/93	akm		Added new wrappers for
