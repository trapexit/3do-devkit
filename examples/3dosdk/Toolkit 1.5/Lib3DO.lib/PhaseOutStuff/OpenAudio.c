 ...
 *					DragonTail6.  Removed conditional compiles and search 
 *					directories for finding dsp files.
 *	08/05/93  JAY	putting in place the final system directory scheme for the
