 ...
 *	File:			OffsetCel.c
 *
 *	Contains:		Routines to apply delta values to cel XY coordinates.
 *
 *	Copyright (c) 1993 The 3DO Company. All Rights Reserved.
 *
 *	History:
 *	04/09/94  Ian	If delta pointer is NULL in OffsetCelList funcs, the
 *					delta is assumed to be zero.  This lets you do just the
 *					copy-perspective part of the operation.
 *	03/01/94  Ian	New today.
 *
