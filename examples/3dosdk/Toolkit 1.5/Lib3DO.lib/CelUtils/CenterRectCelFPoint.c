 ...
 *	07/23/94  Ian	Performance tweaks: more inline calcs instead of calling
 *					other library routines to convert-and-calc.
 *	03/02/94  Ian	Added AA and List versions of all CenterRectCel functions.
