 ...
 *
 *	Contains:		Routines to get cel data buffer size, and similar values
 *					that require poking around in the cel in tricky ways to
 *					obtain simple values.
 *
 *	Copyright:	(c) 1994 The 3DO Company. 	All Rights Reserved.
 *
 *	History:
 *	04/09/94  Ian	Fixed GetCelDataBufferSize() to add 8 bytes if the CCBPRE
 *					flag is not set.
