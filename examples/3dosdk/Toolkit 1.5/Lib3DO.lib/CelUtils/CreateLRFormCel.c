 ...
 *
 *	Contains:	Routine to create cel from a screen or portion of a screen.
 *
 ...
 *	07/23/94  Ian	Screen sizes when subRect is NULL are now taken from the
 *					source screen, not assumed to be 320x240.
 *	04/08/94  Ian	Bug fix: a missing goto ERROR_EXIT was causing a deref of
 *					a NULL pointer if the CreateCel() call failed.
 *	03/15/94  Ian	New today.
 * 
