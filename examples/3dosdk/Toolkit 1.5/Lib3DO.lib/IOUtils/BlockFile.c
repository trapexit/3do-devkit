 ...
 *
 *	History:
 *	07/12/94  Ian	Generally tidied things up and put in more error checking.
 *	07/11/94  Ian	Change includes to just the headers really needed.
 *					Standardized comment blocks.
 *	10/05/93  jb	Fix day-1 "GetBlockFIleBlockSize" typeo
 *	08/09/93  jb	Fix error checking in OpenBlockFile() routine
 *	08/02/93  jb	Change ioi_Pad to ioi_Flags2
 *	04/05/93  jb	Added CreateBlockFileIOReq(), change to not assume
 *					only one I/O request per open BlockFile.
 *	03/25/93  jb	New today, lifted from demo code
 *
 *******************************************************************************************/
