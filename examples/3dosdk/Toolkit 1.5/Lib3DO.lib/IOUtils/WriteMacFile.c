 ...
 *	File:			WriteMacFile.c
 *
 *	Contains:		Routine to write a buffer to a file on the Mac
 *filesystem.
 *
 ...
 *					set by the (now obsolete) OpenMacLink()
 *function.
 *	01/17/94  JAY	change calling parameters in memset call to match
 *prototype. 08/13/93  JAY	clean up for 1p01 release
 *
 ...
 *	word multiple.  (I dunno if this is necessary, but it was in the
 *original code I started with. - Ian)
 *
