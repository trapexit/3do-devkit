 ...
 *
 *	Contains:		Timer utilities routine to obtain a timer IOReq.
 *
 ...
 *	04/23/94  Ian	Added HSec and MSec calls (after rationalizing to myself
 *					that they can be useful despite the overflow issue detailed
 *					in the TimerUtils.h implementation notes).
 *
...
extern int32 ItemOpened(Item);	// handy function the OS guys never told us about.
