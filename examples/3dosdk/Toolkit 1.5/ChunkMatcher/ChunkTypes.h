...
#define	CHAR4LITERAL(a,b,c,d)	((unsigned long)			\
								((unsigned long) a << 24) | \
								((unsigned long) b << 16) | \
								((unsigned long) c << 8)  | \
												 d)
...
#define SANM_HEADER			CHAR4LITERAL('A','H','D','R')   // SANM header chunk sub-type
#define SANM_CCB			CHAR4LITERAL('A','C','C','B')   // SANM CCB chunk sub-type
#define SANM_FRAME			CHAR4LITERAL('F','R','M','E')   // SANM frame chunk sub-type
#define SANM_POS			CHAR4LITERAL('A','P','O','S')   // SANM POSition chunk sub-type
#define SANM_MAP			CHAR4LITERAL('A','M','A','P')   // SANM MAPcel chunk sub-type
...
#define	CHUNK_SNDS			CHAR4LITERAL('S','N','D','S')	// any streamed audio chunk
#define	SNDS_HEADER			CHAR4LITERAL('S','H','D','R')	// audio header chunk
#define	SNDS_SAMPLE			CHAR4LITERAL('S','S','M','P')	// audio sample data chunk

// Streamed Cinepak

#define	CHUNK_FILM			CHAR4LITERAL('F','I','L','M')	// any streamed cinepak chunk
...
#define CELLIST_DOUBLEVISION	CHAR4LITERAL('D','B','L','V')   // Double-Vision cel list
