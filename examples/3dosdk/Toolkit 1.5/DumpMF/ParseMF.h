 ...
 *	File:			ParseMF.h
 *
 *	Contains:		Interface to module which parses Standard MIDIFiles and calls-back
 *					for events in the file.
 *
 *	Usage:			Err	ParseMidiFile( MIDIFileParserPtr mfp );
 *
 *  IMPORTANT: 		READ THE CALLBACK DOCUMENTATION AT THE END OF THIS FILE!!!!!!!
 *
...
#define CHKID(a,b,c,d) ( (((ulong)a) <<24) | (((ulong)b) <<16) | (((ulong)c) <<8) | ((ulong)d))
 ...
 *	 are passed the byte so you can do whatever you want with the distinction.
 *
