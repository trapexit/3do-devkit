 ...
 *
 *	History:
 *	7/12/94		WSD		Addeed framesDropped to context structure -- used for keeping track of dropped frames
 *	7/12/94		WSD		Addeed firstFrameFlag to context structure -- used for skip key frame scheme
 *	3/14/94		lla		Added SetCpakScreen() to locate the display coordinates of the Cpak movie.
 *	1/24/94		jb		Added GetStepEZQCel() and DrawStepEZQToBuffer() stepframe support.
 *	11/23/93	jb		Added prototype for CloseEZQSubscriber()
