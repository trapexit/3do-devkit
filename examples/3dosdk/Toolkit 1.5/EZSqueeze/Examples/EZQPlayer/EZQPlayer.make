...
#   File:       EZQPlayer.make
#
#	Contains:	make file for building EZQPlayer
#
...
#
#	History:
#	06/17/94	dsm		Modified nuplayer.make to create ezqplayer.make
...
AppsDir			=	:Apps & Data:
ObjectDir		=	:Objects:
StreamDir		=	"{3DOFolder}"Streaming:2p1:DataStream:
...
OBJECTS			=	"{ObjectDir}{Program}.c.o"	¶
					...
					"{ObjectDir}PlayEZQStream.c.o"	¶
					"{ObjectDir}EZQTask.c.o"	¶
...
{ObjectDir}PlayEZQStream.c.o		Ä  "PlayEZQStream.h"
