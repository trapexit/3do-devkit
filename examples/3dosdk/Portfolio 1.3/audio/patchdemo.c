...
**  940411 WJB  Added workaround for GetAudioItemInfo() lowmem hit when fed bogus item.
**  940414 WJB  Added several features to PatchSample printout in DumpPatch().
**  940422 WJB  Converted C++ comments to C comments.
**  940422 WJB  Added pinst_AttrFlags and pinst_StateFlags and related defines to PatchInstrument.
