...
**
**	It's important that anything in this module be written as 100%
*reentrant *	code.  Every Lib3DO routine can potentially end up in here, so
*the *	reentrancy of the whole library is related to this module.
**
...
void
Debug3DOBanner (char *title, char *module, int line)
{
  printf ("%s File %s; Line %d # Task %s: ", title, module, line,
