/*
   ...
   3DO Company.
        ...
        Change History (most recent first):
                 ...
                 <1>	 1/5/94		CDE		derived from ourVDL.c
   in the SlideShow example folder
*/
...
/*
 * Fill in a OstandardO VDL - ie. one with a OSystem ClutO ( standard 3DO IMAG
 ...
 *	OactiveO one, ie. one already run through InitVDL above.
 */
void
