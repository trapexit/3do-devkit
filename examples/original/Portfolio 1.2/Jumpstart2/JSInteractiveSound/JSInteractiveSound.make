...
#
#	Contains:	Base version of UFO game with zap sound effect (makefile)
#
...
#
#		 <1>	 1/4/94		CDE		Derived from old Jumpstart's InteractiveUFO.make;
#									Added alert for files used to build command;
#

#####################################
#		Symbol definitions
#####################################
Application		=	JSInteractiveSound
ObjectDir		=	:Objects:
CC				=	armcc
ASM				=	armasm
LINK			=	armlink
