#
#	File:		InstrumentTest.make
#
#	Contains:	Test instrument class (makefile)
#
#	Written by:	pab
#
...
OBJECTS			=	"{ObjectDir}CInstrument.cp.o" 	¶
...
#####################################
{ObjectDir}{Application}.cp.o		Ä	"{3DOLibs}"Lib3DO.lib {Application}.make CInstrument.h
{ObjectDir}CInstrument.cp.o			Ä	"{3DOLibs}"Lib3DO.lib {Application}.make CInstrument.h
