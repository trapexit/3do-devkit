...
/*	AnimCels	- determines the next Cel in this animation to draw and
 *draws it.
 *
 *
 *	Parameters
 ...
 */
void
DrawAnimCel (ANIM *pAnim, Item bitmapItem, long xPos, long yPos,
             frac16 frameIncrement, long hotSpot)
{
  CCB *curCCB;
  Int32 retvalue;
