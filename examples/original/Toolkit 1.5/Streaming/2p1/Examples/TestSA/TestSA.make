...
"{ObjectDir}"TestSA.c.o	A	:::DataStream:DataStreamDebug.h
"{ObjectDir}"TestSA.c.o	A	:::DataStream:DataStream.h
"{ObjectDir}"TestSA.c.o	A	:::DataStream:MsgUtils.h
"{ObjectDir}"TestSA.c.o	A	:::DataStream:MemPool.h
"{ObjectDir}"TestSA.c.o	A	:::DataStream:SubsChunkCommon.h
"{ObjectDir}"TestSA.c.o	A	:::DataStream:HaltChunk.h
"{ObjectDir}"TestSA.c.o	A	:::DataStream:DSStreamHeader.h
"{ObjectDir}"TestSA.c.o	A	:::DataStream:DataStreamLib.h
"{ObjectDir}"TestSA.c.o	A	:::DataStream:DataStream.h
"{ObjectDir}"TestSA.c.o	A	:::DataStream:DataAcq.h
"{ObjectDir}"TestSA.c.o	A	:::DataStream:ItemPool.h
"{ObjectDir}"TestSA.c.o	A	:::DataStream:MarkerChunk.h
"{ObjectDir}"TestSA.c.o	A	:::DataStream:Subscribers:Includes:SubscriberUtils.h
"{ObjectDir}"TestSA.c.o	A	:::DataStream:DataStreamLib.h
"{ObjectDir}"TestSA.c.o	A	:::DataStream:SubsChunkCommon.h
"{ObjectDir}"TestSA.c.o	A	:::DataStream:Subscribers:Includes:SAudioSubscriber.h
"{ObjectDir}"TestSA.c.o	A	:::DataStream:DataStream.h
"{ObjectDir}"TestSA.c.o	A	:::DataStream:Subscribers:Includes:SubscriberUtils.h
"{ObjectDir}"TestSA.c.o	A	:::DataStream:Subscribers:Includes:SAStreamChunks.h
"{ObjectDir}"TestSA.c.o	A	:::DataStream:Subscribers:Includes:SubscriberUtils.h
"{ObjectDir}"TestSA.c.o	A	:::DataStream:Subscribers:Includes:SAChannel.h
"{ObjectDir}"TestSA.c.o	A	:::DataStream:MemPool.h
"{ObjectDir}"TestSA.c.o	A	:::DataStream:Subscribers:Includes:SubscriberUtils.h
"{ObjectDir}"TestSA.c.o	A	:::DataStream:Subscribers:Includes:SATemplates.h
"{ObjectDir}"TestSA.c.o	A	:::DataStream:Subscribers:Includes:SAStreamChunks.h
"{ObjectDir}"TestSA.c.o	A	:::DataStream:Subscribers:Includes:SAControlMsgs.h
"{ObjectDir}"TestSA.c.o	A	:::DataStream:Subscribers:Includes:ControlSubscriber.h
"{ObjectDir}"TestSA.c.o	A	:::DataStream:Subscribers:Includes:SubscriberUtils.h
"{ObjectDir}"TestSA.c.o	A	:::DataStream:ItemPool.h
