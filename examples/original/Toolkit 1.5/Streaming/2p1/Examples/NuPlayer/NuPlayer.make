...
"{ObjectDir}"NuPlayer.c.o	A	:JoyPad.h
"{ObjectDir}"NuPlayer.c.o	A	:PlayCPakStream.h
"{ObjectDir}"NuPlayer.c.o	A	:PrepareStream.h
"{ObjectDir}"NuPlayer.c.o	A	:::DataStream:DataStreamLib.h
"{ObjectDir}"NuPlayer.c.o	A	:::DataStream:DataStream.h
"{ObjectDir}"NuPlayer.c.o	A	:::DataStream:MsgUtils.h
"{ObjectDir}"NuPlayer.c.o	A	:::DataStream:MemPool.h
"{ObjectDir}"NuPlayer.c.o	A	:::DataStream:SubsChunkCommon.h
"{ObjectDir}"NuPlayer.c.o	A	:::DataStream:HaltChunk.h
"{ObjectDir}"NuPlayer.c.o	A	:::DataStream:DSStreamHeader.h
"{ObjectDir}"NuPlayer.c.o	A	:::DataStream:DataAcq.h
"{ObjectDir}"NuPlayer.c.o	A	:::DataStream:ItemPool.h
"{ObjectDir}"NuPlayer.c.o	A	:::DataStream:MarkerChunk.h
"{ObjectDir}"NuPlayer.c.o	A	:::DataStream:Subscribers:Includes:SubscriberUtils.h
"{ObjectDir}"NuPlayer.c.o	A	:::DataStream:DataStreamLib.h
"{ObjectDir}"NuPlayer.c.o	A	:::DataStream:SubsChunkCommon.h
"{ObjectDir}"NuPlayer.c.o	A	:::DataStream:Subscribers:Includes:SAudioSubscriber.h
"{ObjectDir}"NuPlayer.c.o	A	:::DataStream:DataStream.h
"{ObjectDir}"NuPlayer.c.o	A	:::DataStream:Subscribers:Includes:SubscriberUtils.h
"{ObjectDir}"NuPlayer.c.o	A	:::DataStream:Subscribers:Includes:SAStreamChunks.h
"{ObjectDir}"NuPlayer.c.o	A	:::DataStream:Subscribers:Includes:SubscriberUtils.h
"{ObjectDir}"NuPlayer.c.o	A	:::DataStream:Subscribers:Includes:SAChannel.h
"{ObjectDir}"NuPlayer.c.o	A	:::DataStream:MemPool.h
"{ObjectDir}"NuPlayer.c.o	A	:::DataStream:Subscribers:Includes:SubscriberUtils.h
"{ObjectDir}"NuPlayer.c.o	A	:::DataStream:Subscribers:Includes:SATemplates.h
"{ObjectDir}"NuPlayer.c.o	A	:::DataStream:Subscribers:Includes:SAStreamChunks.h
"{ObjectDir}"NuPlayer.c.o	A	:::DataStream:Subscribers:Includes:SAControlMsgs.h
"{ObjectDir}"NuPlayer.c.o	A	:::DataStream:Subscribers:Includes:CPakSubscriber.h
"{ObjectDir}"NuPlayer.c.o	A	:::DataStream:Subscribers:Includes:SubscriberUtils.h
"{ObjectDir}"NuPlayer.c.o	A	:::DataStream:Subscribers:Includes:codec.h
"{ObjectDir}"NuPlayer.c.o	A	:::DataStream:DataStreamLib.h
"{ObjectDir}"NuPlayer.c.o	A	:::DataStream:Subscribers:Includes:ControlSubscriber.h
"{ObjectDir}"NuPlayer.c.o	A	:::DataStream:Subscribers:Includes:SubscriberUtils.h
"{ObjectDir}"NuPlayer.c.o	A	:::DataStream:ItemPool.h
"{ObjectDir}"NuPlayer.c.o	A	:::DataStream:DataStreamDebug.h
...
"{ObjectDir}"PlayCPakStream.c.o	A	:::DataStream:DataAcq.h
"{ObjectDir}"PlayCPakStream.c.o	A	:::DataStream:Subscribers:Includes:SAudioSubscriber.h
"{ObjectDir}"PlayCPakStream.c.o	A	:::DataStream:Subscribers:Includes:CPakSubscriber.h
"{ObjectDir}"PlayCPakStream.c.o	A	:::DataStream:Subscribers:Includes:SubscriberUtils.h
