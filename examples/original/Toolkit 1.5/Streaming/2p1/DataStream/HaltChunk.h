 ...
 *
 *	History:
 *	07/07/94		dtc		Changed haltPart and subsPart to
 *streamerChunk and subscriberChunk in definition of HaltChunk. 07/06/94
 *dtc		Added a newline at end of file, otherwise the compiler chokes.
