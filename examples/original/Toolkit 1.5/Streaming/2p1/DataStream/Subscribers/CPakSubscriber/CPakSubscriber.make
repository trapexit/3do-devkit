...
#	make Depends -f CPakSubscriber.make ** Dev:Null > temp.makeout; temp.makeout ** Dev:Null; delete -i temp.makeout
#
##########################################################################
...
#Objects			=	CPakSubscriber.c.o
#Includes		=	CPakSubscriber.h 
...
OBJECTS			=	"{ObjectDir}CPakSubscriber.c.o"

OBJECTDEPENDS	=	"{ObjectDir}CPakSubscriber.c.depends"
...
"{ObjectDir}"CPakSubscriber.c.o	A	:::DataStreamLib.h
"{ObjectDir}"CPakSubscriber.c.o	A	:::DataStream.h
"{ObjectDir}"CPakSubscriber.c.o	A	:::MsgUtils.h
"{ObjectDir}"CPakSubscriber.c.o	A	:::MemPool.h
"{ObjectDir}"CPakSubscriber.c.o	A	:::SubsChunkCommon.h
"{ObjectDir}"CPakSubscriber.c.o	A	:::HaltChunk.h
"{ObjectDir}"CPakSubscriber.c.o	A	:::DSStreamHeader.h
"{ObjectDir}"CPakSubscriber.c.o	A	:::MsgUtils.h
"{ObjectDir}"CPakSubscriber.c.o	A	:::MemPool.h
"{ObjectDir}"CPakSubscriber.c.o	A	:::ThreadHelper.h
"{ObjectDir}"CPakSubscriber.c.o	A	:::MakeName.h
"{ObjectDir}"CPakSubscriber.c.o	A	::SubscriberUtilities:codec.h
"{ObjectDir}"CPakSubscriber.c.o	A	::SubscriberUtilities:SubscriberUtils.h
"{ObjectDir}"CPakSubscriber.c.o	A	:::DataStreamLib.h
"{ObjectDir}"CPakSubscriber.c.o	A	:::SubsChunkCommon.h
"{ObjectDir}"CPakSubscriber.c.o	A	:CPakSubscriber.h
"{ObjectDir}"CPakSubscriber.c.o	A	::SubscriberUtilities:SubscriberUtils.h
"{ObjectDir}"CPakSubscriber.c.o	A	::SubscriberUtilities:codec.h
"{ObjectDir}"CPakSubscriber.c.o	A	:::DataStreamLib.h
