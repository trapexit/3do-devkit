...
"{ObjectDir}"CPakSubscriberS.c.o	A	:::DataStreamLib.h
"{ObjectDir}"CPakSubscriberS.c.o	A	:::DataStream.h
"{ObjectDir}"CPakSubscriberS.c.o	A	:::MsgUtils.h
"{ObjectDir}"CPakSubscriberS.c.o	A	:::MemPool.h
"{ObjectDir}"CPakSubscriberS.c.o	A	:::SubsChunkCommon.h
"{ObjectDir}"CPakSubscriberS.c.o	A	:::HaltChunk.h
"{ObjectDir}"CPakSubscriberS.c.o	A	:::DSStreamHeader.h
"{ObjectDir}"CPakSubscriberS.c.o	A	:::MsgUtils.h
"{ObjectDir}"CPakSubscriberS.c.o	A	:::MemPool.h
"{ObjectDir}"CPakSubscriberS.c.o	A	:::ThreadHelper.h
"{ObjectDir}"CPakSubscriberS.c.o	A	:::MakeName.h
"{ObjectDir}"CPakSubscriberS.c.o	A	::SubscriberUtilities:codec.h
"{ObjectDir}"CPakSubscriberS.c.o	A	::SubscriberUtilities:SubscriberUtils.h
"{ObjectDir}"CPakSubscriberS.c.o	A	:::DataStreamLib.h
"{ObjectDir}"CPakSubscriberS.c.o	A	:::SubsChunkCommon.h
