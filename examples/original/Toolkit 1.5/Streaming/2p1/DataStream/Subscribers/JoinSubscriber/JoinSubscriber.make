...
"{ObjectDir}"JoinSubscriber.c.o	A	:::DataStreamLib.h
"{ObjectDir}"JoinSubscriber.c.o	A	:::DataStream.h
"{ObjectDir}"JoinSubscriber.c.o	A	:::MsgUtils.h
"{ObjectDir}"JoinSubscriber.c.o	A	:::MemPool.h
"{ObjectDir}"JoinSubscriber.c.o	A	:::SubsChunkCommon.h
"{ObjectDir}"JoinSubscriber.c.o	A	:::HaltChunk.h
"{ObjectDir}"JoinSubscriber.c.o	A	:::DSStreamHeader.h
"{ObjectDir}"JoinSubscriber.c.o	A	:::MsgUtils.h
"{ObjectDir}"JoinSubscriber.c.o	A	:::MemPool.h
"{ObjectDir}"JoinSubscriber.c.o	A	:::ThreadHelper.h
"{ObjectDir}"JoinSubscriber.c.o	A	:::MakeName.h
"{ObjectDir}"JoinSubscriber.c.o	A	::SubscriberUtilities:SubscriberUtils.h
"{ObjectDir}"JoinSubscriber.c.o	A	:::DataStreamLib.h
"{ObjectDir}"JoinSubscriber.c.o	A	:::SubsChunkCommon.h
