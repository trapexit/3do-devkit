...
/**************************************************************************
 * 3d_stereo_stuff : contains init and driver routines                    *
 **************************************************************************
 *                                                                        *
...
init_worlds ()
{
  ...
  static TagArg worldtags[]
      = { F3D_TAG_EYE_SEP,  (void *)(6 << 12), F3D_TAG_FACE_ORIENTATION,
          (void *)CW_FACES, F3D_TAG_DONE,      0 };
...
move_things ()
{
  static long angle1 = 140, angle2 = 0, angle3 = 0, angle4 = 0;
  frac16 tempf16;
  ...
  World_pyramid1.wo_WorldPosition[X_COORD] = MulSF16 (tempf16, (15 << 16));
