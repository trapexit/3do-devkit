 ...
 *UTILS3DO_H. Standardized comment blocks. 06/15/93  JAY	change
 *SET_TO_NORMAL macro to use new name(ccb_PIXC) for old name(ccb_PPMPC).
 ...
 *
 *	This header is all but obsolete.  It includes Parse3DO.h, which
 *includes most of the current headers (CelUtils, AnimUtils, etc).  This header
...
{                       /* what is this and what's it for and who */
...
extern "C"
{
  ...
  void PreMoveCel (CCB *ccb, Point *beginQuad, Point *endQuad,
  ...
  void SetRectf16 (Rectf16 *r, Coord left, Coord top, Coord right,
                   Coord bottom);
