/*
   ...
   3DO Company.
        ...
        Change History (most recent first):
                 ...
                 <3>	  9/6/93	JAY		change nNumVoices
   parameter in LoadInstrument to 0 for DragonTail6 and removed search
   directories for dsp files and conditional compiles for old systems
