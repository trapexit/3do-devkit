 ...
 *Added GetStepCPakCel() and DrawStepCPakToBuffer() stepframe support. 11/23/93
 *jb		Added prototype for CloseCPakSubscriber() 4/28/93
 *njc		New today.
 *
 *******************************************************************************************/
...
void SetCpakScreen (int32 horizontalOffset, int32 verticalOffset,
                    Boolean centered);
...
void DrawStepCPakToBuffer (CPakContextPtr ctx, CPakRecPtr cpRecPtr,
                           Bitmap *bitmap);
