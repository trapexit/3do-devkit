...
#	File:		JSShowCel.make
#
#	Contains:	Demonstrate how to display an image and a cel (makefile)
#
...
#
#		 <1>	  1/3/94	CDE		Derived from old Jumpstart's BasicUFO.make;
#									added alert to build commands;
#									modified application dependencies
#

#####################################
#		Symbol definitions
#####################################
Application		=	JSShowCel
ObjectDir		=	:Objects:
CC				=	armcc
ASM				=	armasm
LINK			=	armlink
...
#####################################
{ObjectDir}{Application}.c.o		A	"{3DOLibs}"Lib3DO.lib {Application}.make