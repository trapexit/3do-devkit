/*
   ...
   3DO Company.
        ...
        Change History (most recent first):
                                 ...
                                 5/09/94	crm		removed
   explicit references to GrafBase struct <5>	 1/18/94	JAY
   change MergeVDL function definition to match the prototype in ourVDL.h due
   to stricker type checking by 1.6v2 armcc <4>	 8/11/93	JAY
   remove 2 filler words from DMA control word 'length' field because of change
   in SubmitVDL's verification process. check DMA control word of vlds loaded
   from disk and adjust if length field includes filler words
                 <3>	 6/23/93	JAY		intergrated ec's
   changes for Dragon (4B1) <2>	 3/18/93	JAY		commented out
   tempLong local variable. It is not used <1>	 3/18/93	JAY
   first checked in 2/17/93		ec		Added VDL diddling
   routines. 2/15/93		ec		Add CorrectVDL for Magneto6
