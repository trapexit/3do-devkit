/* $Id: ta_envelope.c,v 1.15 1994/03/01 01:36:27 shawn Exp $ */
/***************************************************************
**
** Test various envelope options by passing test index.
**         ta_envelope.arm <n>
** Use the envelope to modulate amplitude of sawtooth.
** Two voices can be tested together.
** Buttons start or stop voices:
**     A = voice A
**     B = voice B
**     C = voice A & B
** Up and Down arrows change envelope time scaling.
**
** By:  Phil Burk
**
