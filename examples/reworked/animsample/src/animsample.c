...
/**
   ...
   |||	  Description
   |||
   |||	    Demonstrates loading and displaying an animation and a background
   image.
   |||
   |||	    The program allows the user to change the animation's frame rate,
   the four
...
Usage (void)
{
  ...
  printf("C                     toggles between moving cel mode, and warping "
         "cel mode\n");
  printf("d-pad                 moves cel around or warps corners\n");
