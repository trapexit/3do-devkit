...
/*	Show the user the acceptable command line formats */
{
  ...
  printf("   \"imagelist24.txt\" is used if none is specified.\n");
  printf("   when displaying NTSC video.  The name\n");
  printf("   \"palimagelist24.txt\" is used if none is specified.\n");
  printf("   when displaying PAL video.\n");
  printf("   Options:\n");
