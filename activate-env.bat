...
if /i "%~1"=="--deactivate" goto DeactivateFromMain
if /i "%~1"=="/deactivate" goto DeactivateFromMain
if /i "%~1"=="d" goto DeactivateFromMain
...
:DevkitPathResolved
if exist "%__TDO_RESOLVED_DEVKIT_PATH%\." goto DevkitDirectoryExists
...
echo 3DO development environment activated. Run 'deactivate' to deactivate.
exit /b 0
...
if defined __TDO_DEACTIVATE_DIR if exist "%__TDO_DEACTIVATE_DIR%\." rmdir /s /q "%__TDO_DEACTIVATE_DIR%" >nul 2>nul
call :ClearTransientVariables
exit /b 1
...
if defined __TDO_ACTIVATE_DEACTIVATE_DIR if exist "%__TDO_ACTIVATE_DEACTIVATE_DIR%\." rmdir /s /q "%__TDO_ACTIVATE_DEACTIVATE_DIR%" >nul 2>nul
...
if exist "%__TDO_DEACTIVATE_DIR%\." goto DeactivateDirExists
...
:DeactivateDirExists
set "__TDO_DEACTIVATE_SCRIPT=%__TDO_DEACTIVATE_DIR%\deactivate.bat"
...
>> "%__TDO_DEACTIVATE_SCRIPT%" echo rem Generated by activate-env.bat.
